...
class GalleryController extends Controller
{
    public function index(){
        ...
        return view('manager.pages.manage-gallery-index', $data);
    }
    ...
    public function create(){
        ...
        return view('manager.pages.manage-gallery-create', $data);
    }
    public function edit($id){
        ...
        return view('manager.pages.manage-gallery-edit', $data);
    }
