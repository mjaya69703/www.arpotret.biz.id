...
class GalleryController extends Controller
{
    public function index(){
        ...
        $data['gallery'] = Gallery::where('author_id', Auth::guard()->user()->id)->get();

        return view('fotografer.pages.manage-gallery-index', $data);
    }
    public function create(){
        ...
        return view('fotografer.pages.manage-gallery-create', $data);
    }
    public function edit($id){
        ...
        return view('fotografer.pages.manage-gallery-edit', $data);
    }
