...
<section class="section">
    <div class="row">
        <div class="col-lg-6">
            <div class="card" id="15sRefresh">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h4>Sesi Konsultasi #{{ strtoupper($connect->connect_code) }} - {{ Illuminate\Support\Facades\Crypt::decryptString($connect->connect_subject) }}</h4>
                    <div class="">
                        <a href="{{ route('manager.manage-connect.index') }}" class="btn btn-outline-warning"><i class="fa-solid fa-backward"></i></a>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-6">
            <form action="{{ route('manager.manage-connect.replyAdmin') }}" method="POST" enctype="multipart/form-data">
            @csrf

            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4>Balas Pesan #{{ strtoupper($connect->connect_code) }} - {{ Illuminate\Support\Facades\Crypt::decryptString($connect->connect_subject) }}</h4>
                    <div class="">
