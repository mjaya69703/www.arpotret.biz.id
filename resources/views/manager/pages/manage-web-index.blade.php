...
@section('content')
    <section class="section">
        <form action="{{ route('manager.manage-web.update') }}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
                ...
                <div class="col-lg-8 col-12">
                    <div class="card">
                        ...
                        <div class="row card-body">
                            ...
                            <div class="form-group col-lg-6 col-12">
                                <label for="site_link">Nama Website</label>
                                <input type="text" name="site_link" id="site_link" class="form-control" placeholder="Inputkan nama website..." value="{{ $web->site_link }}">
                                @error('site_link') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>
                            <div class="form-group col-lg-6 col-12">
                                <label for="site_head">Nama Website</label>
                                <input type="text" name="site_head" id="site_head" class="form-control" placeholder="Inputkan nama website..." value="{{ $web->site_head }}">
                                @error('site_head') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>
                            <div class="form-group col-lg-6 col-12">
                                <label for="site_desc">Nama Website</label>
                                <input type="text" name="site_desc" id="site_desc" class="form-control" placeholder="Inputkan nama website..." value="{{ $web->site_desc }}">
