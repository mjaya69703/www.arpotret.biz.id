    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-4 col-12 mb-3">
                <form action="{{ route('manager.manage-blog.category-store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center align-items-center">
                                                ...
                                                <form id="delete-form-{{ $item->id }}"
                                                    action="{{ route('manager.manage-blog.category-destroy', $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a type="button" class="bs-tooltip btn btn-rounded btn-outline-danger"
                                                        data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                        data-original-title="Delete"
                                                        data-url="{{ route('manager.manage-blog.category-destroy', $item->id) }}"
                                                        data-name="{{ $item->name }}"
