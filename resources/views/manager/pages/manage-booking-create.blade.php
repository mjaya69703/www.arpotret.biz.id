...
@section('content')
    <section class="section">
        <form action="{{ route('manager.manage-booking.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-lg-8 col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="">
                                <a href="{{ route('manager.manage-booking.index') }}" class="btn btn-outline-warning"><i class="fa-solid fa-backward"></i></a>
                                <button type="submit" class="btn btn-outline-primary"><i class="fa-solid fa-paper-plane"></i></button>
                            </div>
                        </div>
                        <div class="card-body">
