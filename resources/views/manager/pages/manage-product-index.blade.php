                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="">
                            ...
                            <a href="{{ route('manager.manage-product.create') }}" class="btn btn-outline-primary"><i class="fa-solid fa-plus"></i></a>
                            ...
                            <table class="table table-striped" id="table1">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Author Product</th>
                                    ...
                                    @foreach ($product as $key => $item)
                                        <tr>
                                            ...
                                            <td class="text-center"><img
                                                    src="{{ asset('storage/images/product/cover/' . $item->product_cover) }}"
                                            ...
                                            <td class="d-flex justify-content-center align-items-center">
                                                <a href="{{ route('manager.manage-product.edit', $item->id) }}" style="margin-right: 10px"
                                                    class="btn btn-outline-primary"><i class="fas fa-edit"></i></a>
                                                <form id="delete-form-{{ $item->id }}"
                                                    action="{{ route('manager.manage-product.destroy', $item->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a type="button" class="bs-tooltip btn btn-rounded btn-outline-danger"
                                                        ...
                                                        data-url="{{ route('manager.manage-product.destroy', $item->id) }}"
                                                        data-name="{{ $item->name }}"
