...
<section class="section">
    ...
    <div class="me-1 mb-1 d-inline-block">
        <!--large size Modal -->
        <form action="{{ route('manager.manage-booking.cetak') }}" method="POST" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="modal-body row">
                        ...
                        <div class="form-group col-12 mb-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                {{-- <a href="{{ route('manager.manage-booking.cetak', ['month' => 'all', 'year' => '2023']) }}" class="btn btn-outline-primary btn-rounded" style="margin-left: 10px "><i class="fa-solid fa-envelope"></i></a> --}}
                            </div>
                        </div>
                    </div>
                </div>
        ...
        @foreach ($book as $item)
        <form action="{{ route('manager.manage-booking.update', $item->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body row">
                            ...
                            <div class="form-group col-lg-12 col-12 mb-3 text-center">
                                ...
                                <br><hr>
                                <img src="{{ asset('storage/images/payment/'. $item->book_payment) }}" alt="">
                            </div>
...
<script>
    ...
    function updateUrl() {
        var month = document.getElementById('month').value;
        var year = document.getElementById('year').value;
        var url = "{{ route('manager.manage-booking.cetak', ['month' => 'MONTH', 'year' => 'YEAR']) }}";
