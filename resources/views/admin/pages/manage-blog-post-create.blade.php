...
@section('content')
    <section class="section">
        <form action="{{ route('admin.manage-blog.posts-store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="card-title">Tambah Data Postingan</h4>
                            <div class="">
                                <a href="{{ route('admin.manage-blog.posts-index') }}" class="btn btn-outline-warning"><i class="fa-solid fa-backward"></i></a>
                                <button type="submit" class="btn btn-outline-primary"><i class="fa-solid fa-paper-plane"></i></button>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-lg-12 col-12">
                                    ...
                                    <input type="text" class="form-control" name="post_title" id="post_title" placeholder="Inputkan judul postingan...">
                                    @error('post_title')
                                ...
                                <div class="form-group col-lg-6 col-12">
                                    ...
                                    <select name="tags[]" class="choices form-select multiple-remove" multiple="multiple">
                                        <option value="" selected>Pilih Tags</option>
                                        @foreach ($tag as $item)
                                ...
                                <div class="form-group col-lg-12 col-12">
                                    ...
                                    <input type="text" class="form-control" name="post_keyword" id="post_keyword" placeholder="Inputkan keyword postingan...">
                                    @error('post_keyword')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="form-group col-lg-12 col-12">
                                    ...
                                    <input type="text" class="form-control" name="post_metadesc" id="post_metadesc" placeholder="Inputkan metadesc postingan...">
                                    @error('post_metadesc')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group col-lg-12 col-12">
                                ...
                                <textarea name="post_desc" id="summernote" class="form-control" cols="5" rows="10" placeholder="Inputkan isi postingan..."></textarea>
                                @error('post_desc')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
