...
@section('content')
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="">
                            ...
                            {{-- <a href="{{ route('admin.manage-product.rating-create') }}" class="btn btn-outline-primary"><i class="fa-solid fa-plus"></i></a> --}}
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center align-items-center">
                                                ...
                                                <form id="delete-form-{{ $item->id }}"
                                                    action="{{ route('admin.manage-product.rating-destroy', $item->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a type="button" class="bs-tooltip btn btn-rounded btn-outline-danger"
                                                        ...
                                                        data-url="{{ route('admin.manage-product.rating-destroy', $item->id) }}"
                                                        data-name="{{ $item->name }}"
    ...
    <div class="me-1 mb-1 d-inline-block">
        ...
        <div class="modal fade" id="editRate{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="tabsModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form action="{{ route('admin.manage-product.rating-update', $item->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="modal-content">
                        <div class="modal-header" style="font-size: 20px">
