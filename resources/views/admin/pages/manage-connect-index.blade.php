...
<section class="section">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center align-items-center">
                                        <a href="{{ route('admin.manage-connect.view', $item->connect_code) }}" style="margin-right: 10px" class="btn btn-outline-info">
    ...
    <div class="me-1 mb-1 d-inline-block">
        <!--large size Modal -->
        <form action="{{ route('admin.manage-connect.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
