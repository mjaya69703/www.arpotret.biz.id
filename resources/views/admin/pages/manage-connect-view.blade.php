...
<section class="section">
    <div class="row">
        <div class="col-lg-6">
            <div class="card" id="15sRefresh">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div class="">
                        <a href="{{ route('admin.manage-connect.index') }}" class="btn btn-outline-warning"><i class="fa-solid fa-backward"></i></a>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-6">
            <form action="{{ route('admin.manage-connect.replyAdmin') }}" method="POST" enctype="multipart/form-data">
            @csrf
