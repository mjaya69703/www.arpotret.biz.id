                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="">
                            ...
                            <a href="{{ route('admin.manage-product.portofolio-create') }}" class="btn btn-outline-primary"><i class="fa-solid fa-plus"></i></a>
                                    ...
                                    @foreach ($gallery as $key => $item)
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center align-items-center">
                                                <a href="{{ route('admin.manage-product.portofolio-edit', $item->id) }}" style="margin-right: 10px"
                                                    class="btn btn-outline-primary"><i class="fas fa-edit"></i></a>
                                                <form id="delete-form-{{ $item->id }}"
                                                    action="{{ route('admin.manage-product.portofolio-destroy', $item->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a type="button" class="bs-tooltip btn btn-rounded btn-outline-danger"
                                                        ...
                                                        data-url="{{ route('admin.manage-product.portofolio-destroy', $item->id) }}"
                                                        data-name="{{ $item->name }}"
