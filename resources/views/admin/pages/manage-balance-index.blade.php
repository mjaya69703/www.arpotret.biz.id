...
@section('content')
    <section class="section">
        <div class="row">
            <div class="col-lg-4 col-12 mb-3">
                <form action="{{ route('admin.manage-balance.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center align-items-center">
                                                ...
                                                <form id="delete-form-{{ $item->id }}"
                                                    action="{{ route('admin.manage-balance.destroy', $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a type="button" class="bs-tooltip btn btn-rounded btn-outline-danger"
                                                        data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                        data-original-title="Delete"
                                                        data-url="{{ route('admin.manage-balance.destroy', $item->id) }}"
                                                        data-name="{{ $item->name }}"
    ...
    <div class="me-1 mb-1 d-inline-block">
        ...
        <form action="{{ route('admin.manage-balance.update', $item->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
