    ...
    <div class="col-lg-9">
        <div class="row">
            <div class="col-lg-3 col-12 mb-2">
                <a href="{{ route('admin.manage-balance.bal-pending') }}">
            ...
            <div class="col-lg-3 col-12 mb-2">
                <a href="{{ route('admin.manage-balance.bal-sekarang') }}">
                    <div class="card btn btn-outline-success">
                        <div class="card-body d-flex justify-content-around align-items-center">
            ...
            <div class="col-lg-3 col-12 mb-2">
                <a href="{{ route('admin.manage-booking.book-onprocess') }}">
                    <div class="card btn btn-outline-success">
                        <div class="card-body d-flex justify-content-around align-items-center">
            ...
            <div class="col-lg-3 col-12 mb-2">
                <a href="{{ route('admin.manage-booking.book-finished') }}">
                    <div class="card btn btn-outline-success">
                        <div class="card-body d-flex justify-content-around align-items-center">
            ...
            <div class="col-lg-3 col-12 mb-2">
                <a href="{{ route('admin.manage-member.index') }}">
                    <div class="card btn btn-outline-success">
                        <div class="card-body d-flex justify-content-around align-items-center">
            ...
            <div class="col-lg-3 col-12 mb-2">
                <a href="{{ route('admin.manage-product.rating-index') }}">
                    <div class="card btn btn-outline-success">
                        <div class="card-body d-flex justify-content-around align-items-center">
    ...
    <div class="col-lg-3">
        <div class="card">
            ...
            <div class="card-body row">
                ...
                @endif
                <div class="col-lg-12 col-12 d-flex justify-content-center">
                    <a href="{{ route('admin.manage-blog.posts-index') }}" class="btn btn-primary">Check more for news...</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body row">
                        ...
                        <div class="col-lg-12 col-12 mb-3">
                            <div class="d-flex justify-content-start">
                                ...
                                {{-- <p style="font-size: 20px; margin-left: 20px;">Jaya Kusuma <br> General Admin</p> --}}
                                <span style="margin-left: 20px; font-size: 20px;">{{ $item->users->name }} <br> <a href="{{ route('admin.manage-connect.view', $item->connect_codr) }}">Reply #<span style="text-transform: uppercase">{{ $item->connect_codr }}</span></a></span>
                        ...
                        @endforelse
                        <div class="col-lg-12 col-12 d-flex justify-content-center">
                            <a href="{{ route('admin.manage-connect.index') }}" class="btn btn-primary">Check more connect...</a>
                        </div>
                    </div>
                </div>
            </div>
