...
@section('content')
    <section class="section">
        <form action="{{ route('fotografer.manage-product.portofolio-store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="">
                                <a href="{{ route('fotografer.manage-product.portofolio-index') }}" class="btn btn-outline-warning"><i class="fa-solid fa-backward"></i></a>
                                <button type="submit" class="btn btn-outline-primary"><i class="fa-solid fa-paper-plane"></i></button>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-lg-12 col-12">
                                    ...
                                    <input type="text" class="form-control" name="gallery_name" id="gallery_name" placeholder="Inputkan nama album gallery...">
                                    @error('gallery_name')
                                ...
                                <div class="form-group col-lg-12 col-12">
                                    ...
                                    <textarea name="gallery_desc" id="dark" class="form-control" cols="5" rows="10" placeholder="Inputkan deskripsi gallery..."></textarea>
                                    @error('gallery_desc')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                ...
                <div class="col-lg-4 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <img id="{{ $image }}-preview" src="{{ asset('storage/images/gallery/' . $web->$image) }}" class="card-img-top" alt="" style="display: none;">
